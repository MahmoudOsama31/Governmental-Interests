...
namespace GI.Models
{
    public class MarriageCertificate
    {
        ...
        [StringLength(60, MinimumLength = 15, ErrorMessage = "ادخل الاسم بالكامل")]
        [DataType(DataType.Text, ErrorMessage = "ادخل الاسم بشكل صحيح")]
        public string FullName { get; set; }

        [Required(ErrorMessage = "ادخل اسم الام")]
        [DataType(DataType.Text, ErrorMessage = "ادخل الاسم بشكل صحيح")]
        public string FirstMotherName { get; set; }
        ...
        [StringLength(150, ErrorMessage ="ادخل العنوان بالتفصيل")]
        ...
        [Required(ErrorMessage = " ادخل اسم الام للزوج/الزوجه")]
        [DataType(DataType.Text, ErrorMessage = "ادخل الاسم بشكل صحيح")]
        public string SecondMotherName { get; set; }
        ...
        [Required(ErrorMessage = " ادخل اسم للزوج/الزوجه")]
        [DataType(DataType.Text, ErrorMessage = "ادخل الاسم بشكل صحيح")]
